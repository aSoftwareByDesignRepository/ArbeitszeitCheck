/**
 * Forward legacy /admin/settings#… mega-page bookmarks to the owning
 * global settings page (AdminSettingsSectionCatalog::LEGACY_ANCHORS via server payload).
 *
...
(function (root) {
	...
	/**
	 * @param {object|null|undefined} payload window.ArbeitszeitCheck.adminSettingsPages
	...
	function run() {
		const payload = root && root.ArbeitszeitCheck && root.ArbeitszeitCheck.adminSettingsPages;
	...
	if (root) {
		...
		root.ArbeitszeitCheck.AdminSettingsLegacyRedirect = api;
